  ...
  getSession(sessionId: string): Promise<Session> {
    return Promise.resolve({
      ...
      menu: [
        {
          id: "1",
          name: "1 Pfund Fritten",
          description: "3 Gramm mehr als 450 Gramm Fritten!",
          price: 690,
        },
        {
          id: "2",
          name: "Lagerfeuer",
          description: "Möglicherweise etwas scharf",
          price: 1000,
        },
      ...
      users: [
        ...
        },
        {
          id: "2",
          name: "User 2",
          orders: [{ id: "O51O573031", name: "Menü Avocado", price: 1480 }],
        },
      ],
    });
  }
